$(document).ready(function () {
    ...
    $(document).ready(function() {
        $('.attribute__button').click(function() {
            let attributeItem = $('<div>').addClass('attribute__item');

            let attributeInputGroup = $('<div>').addClass('attribute__input-group');
            ...
            let attributeDeleteDiv = $('<div>').addClass('attribute__delete');
            let deleteButton = $('<a>').addClass('attribute__delete-btn').click(function() {
