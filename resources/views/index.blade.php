...
{{--                            <div class="attribute__input-group">--}}
{{--                                <label for="attribute_name" class="modal__label">Название</label>--}}
{{--                                <input id="attribute_name" type="text" class="attribute__input" name="attribute_name" required>--}}
{{--                            </div>--}}
{{--                            <div class="attribute__input-group">--}}
{{--                                <label for="attribute_value" class="modal__label">Значение</label>--}}
{{--                                <input id="attribute_value" type="text" class="attribute__input" name="attribute_value" required>--}}
{{--                            </div>--}}
{{--                            <div class="attribute__delete">--}}
{{--                                <a class="attribute__delete-btn">--}}
