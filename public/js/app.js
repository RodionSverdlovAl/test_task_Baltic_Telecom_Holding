...
/***/ "./resources/js/ajax/add-product.js":
/*!******************************************!*\
  !*** ./resources/js/ajax/add-product.js ***!
  \******************************************/
/***/ (() => {
...
$(document).ready(function () {
  $('#productForm').submit(function (event) {
    ...
    var createRoute = $(this).data('create_route');
    ...
    $('.attribute__item').each(function () {
      var name = $(this).find('.attribute__input[name="attribute_name"]').val();
      var value = $(this).find('.attribute__input[name="attribute_value"]').val();
      if (name && value) {
...
__webpack_require__(/*! ./modal-window */ "./resources/js/modal-window.js");
__webpack_require__(/*! ./custom-select */ "./resources/js/custom-select.js");
__webpack_require__(/*! ./ajax/add-product */ "./resources/js/ajax/add-product.js");
...
$('.custom-select').each(function () {
  ...
  var selectedOptionValueInput = $(this).find('#selectedOptionValue');
  var optionsList = $(this).find('.options');
...
$(document).ready(function () {
  ...
  $('.attribute__button').click(function () {
    var attributeItem = $('<div>').addClass('attribute__item');
    var attributeInputGroup = $('<div>').addClass('attribute__input-group');
    attributeInputGroup.append($('<label>').attr('for', 'attribute_name').addClass('modal__label').text('Название'));
    attributeInputGroup.append($('<input>').attr({
      id: 'attribute_name',
      type: 'text',
    ...
    attributeItem.append(attributeInputGroup);
    attributeInputGroup = $('<div>').addClass('attribute__input-group');
    attributeInputGroup.append($('<label>').attr('for', 'attribute_value').addClass('modal__label').text('Значение'));
    attributeInputGroup.append($('<input>').attr({
      id: 'attribute_value',
      type: 'text',
      "class": 'attribute__input',
